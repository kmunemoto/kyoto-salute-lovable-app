...
export const translations: Record<Lang, Dict> = {
  ja: {
    meta: { title: "御所南のパーソナルジム Salute｜中京区・丸太町駅徒歩8分｜無料体験実施中", description: "御所南・中京区の完全個室パーソナルジム Salute御所南。丸太町駅徒歩8分。栄養士トレーナーがマンツーマンで指導。1回¥4,000〜・入会金¥0。無料体験受付中。" },
    ...
    faq: { kicker: "Q&A", title: "よくある質問", items: [
      ...
      { question: "予約のキャンセルや変更はできますか？", answer: "予約の変更・キャンセルは前日までにご連絡いただければ、キャンセル料やセッションの消費は発生しません。ただし、当日のキャンセル（およびご連絡のない無断キャンセル）の場合は、1回分（1セッション）を消費した扱いとなりますので、あらかじめご了承ください。" },
    ] },
  ...
  en: {
    ...
    faq: { kicker: "Q&A", title: "FAQ", items: [
      ...
      { question: "Can I change or cancel a reservation?", answer: "Changes and cancellations are free of charge if you contact us by the day before. Same-day cancellations (and no-shows) count as using one session, so please book with that in mind." },
    ] },
  ...
  zh: {
    meta: { title: "京都御所南私人教练健身房 | Salute", description: "Salute 是位于京都御所南的私人教练健身房。提供免费体验课程，也支持面向游客的单次训练，无需会员注册。距离丸太町站步行8分钟。" },
    nav: { features: "特点", trainer: "教练", voice: "客户评价", plan: "价格方案", faq: "常见问题", access: "交通指南", consultation: "免费体验", blog: "博客" },
    header: { ctaBtn: "预约免费体验" },
    hero: { kicker: "京都御所南的私人教练健身房 Salute｜免费体验中", title1: "一个人运动总是难以坚持？", titleAccent: "御所南的一对一私人教练健身房。", sub: "超越过去的自己，遇见更好的体态与状态", desc: "拥有营养师资格的教练，按照您的节奏耐心指导。每次4,000日元起，无入会费，运动服・鞋・毛巾・水均免费提供，轻松开始、轻松坚持。", cta1: "预约免费体验", cta2: "查看健身房特色" },
    ...
    ], dropIn: { name: "单次训练（适合来京都旅行的游客）", price: "¥8,000", perSession: "1次", description: "无需会员注册，全套装备免费提供，适合来京都旅行的游客。", features: ["60分钟一对一训练", "无需会员注册", "运动服・鞋免费提供", "可支持简单英语沟通"] }, cta: "预约免费体验" },
    ...
    cta: { kicker: "Consultation", title: "免费体验课程", paragraphs: ["欢迎先来体验一次。", "入会前的各种疑问都可以在免费体验中得到解答。", "亲身感受训练内容与健身房的氛围。"], bullets: ["担心自己不擅长运动…", "想了解教练是什么样的…"], webBtn: "在线预约免费体验", lineBtn: "通过LINE预约" },
    faq: { kicker: "Q&A", title: "常见问题", items: [
      { question: "免费体验都做些什么？", answer: "进行简短咨询后，体验60分钟的真实私人训练课程。运动服与鞋子免费提供，空手前来即可。" },
      ...
      { question: "可以更改或取消预约吗？", answer: "如在前一天之前联系我们，更改或取消预约不会产生费用或消耗次数。但当日取消（及无故爽约）将视为消耗1次（1节课），敬请谅解。" },
    ] },
  ...
  zhTW: {
    ...
    faq: { kicker: "Q&A", title: "常見問題", items: [
      ...
      { question: "可以更改或取消預約嗎？", answer: "如在前一天之前與我們聯繫，更改或取消預約不會產生費用或消耗次數。但當日取消（及無故爽約）將視為消耗1次（1堂課），敬請見諒。" },
    ] },
  ...
  ko: {
    meta: { title: "교토 고쇼미나미 퍼스널 트레이닝 짐 | Salute", description: "Salute는 교토 고쇼미나미에 위치한 퍼스널 트레이닝 짐입니다. 무료 체험과 여행객을 위한 1회 이용 트레이닝을 제공합니다. 1회 이용 시 회원가입은 필요하지 않습니다. 마루타마치역에서 도보 8분." },
    nav: { features: "특징", trainer: "트레이너", voice: "고객 후기", plan: "요금제", faq: "자주 묻는 질문", access: "오시는 길", consultation: "무료 체험", blog: "블로그" },
    header: { ctaBtn: "무료 체험 예약" },
    hero: { kicker: "교토 고쇼미나미의 퍼스널 트레이닝 짐 Salute｜무료 체험 예약 가능", title1: "혼자서는 운동을 꾸준히 이어가기 어려우셨나요?", titleAccent: "고쇼미나미의 1:1 퍼스널 트레이닝 짐.", sub: "과거의 나를 넘어, 인생 최고의 컨디션으로", desc: "영양사 자격을 가진 트레이너가 회원님의 페이스에 맞춰 꼼꼼하게 서포트합니다. 1회 ¥4,000부터, 입회비 없이 시작할 수 있고 운동복・신발・수건・물도 모두 무료로 제공합니다.", cta1: "무료 체험 예약", cta2: "특징 자세히 보기" },
    ...
    ], dropIn: { name: "1회 이용 (교토 여행객용)", price: "¥8,000", perSession: "1회", description: "회원가입 없이 1회 이용 가능. 교토 여행 중에도 이용하기 좋습니다.", features: ["60분 1:1 트레이닝", "회원가입 불필요", "운동복・신발 무료 제공", "간단한 영어 응대 가능"] }, cta: "무료 체험 예약" },
    flow: { kicker: "Flow", title: "무료 체험 안내", steps: [
    ...
    cta: { kicker: "Consultation", title: "무료 체험 안내", paragraphs: ["먼저 가볍게 체험해 보세요.", "입회 전의 다양한 궁금증은 무료 체험에서 해소하실 수 있습니다.", "트레이닝 내용과 짐 분위기를 직접 느껴 보세요."], bullets: ["운동이 익숙하지 않아 걱정되시나요?", "트레이너가 어떤 사람인지 궁금하신가요?"], webBtn: "온라인으로 무료 체험 예약", lineBtn: "LINE으로 예약" },
    faq: { kicker: "Q&A", title: "자주 묻는 질문", items: [
      { question: "무료 체험에서는 무엇을 하나요?", answer: "간단한 상담 후 실제와 동일한 60분간의 퍼스널 트레이닝을 체험하실 수 있습니다. 운동복・신발・수건・물 모두 무료로 제공되므로 빈손으로 오시면 됩니다." },
      ...
      { question: "예약 변경이나 취소가 가능한가요?", answer: "예약 변경·취소는 전날까지 연락 주시면 취소 수수료나 횟수 차감이 발생하지 않습니다. 다만 당일 취소(및 무단 취소)의 경우 1회분(1세션)을 사용한 것으로 처리되오니 양해 부탁드립니다." },
    ] },
