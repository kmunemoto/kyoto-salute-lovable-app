...
export const translations: Record<Lang, Dict> = {
  ja: {
    ...
    ], dropIn: { name: "単発プラン（ビジター・観光客向け）", price: "¥8,000", perSession: "1回", description: "会員登録不要・手ぶらOK", features: ["1セッション50分", "会員登録不要", "ウェア・シューズ無料レンタル", "手ぶらOK"] }, option: { label: "オプション", name: "パーソナルストレッチ", duration: "30分", price: "¥3,000", unit: "（税込）/回", description: "トレーニングの後に追加していただけるオプションです。トレーナーがマンツーマンで30分間、体をほぐすストレッチを行います。" }, cta: "まずは体験してみる" },
  ...
  zh: {
    ...
    ], dropIn: { name: "单次训练（适合来京都旅行的游客）", price: "¥8,000", perSession: "1次", description: "无需会员注册，全套装备免费提供，适合来京都旅行的游客。", features: ["50分钟一对一训练", "无需会员注册", "运动服・鞋免费提供", "可支持简单英语沟通"] }, option: { label: "选配", name: "私人拉伸", duration: "30分钟", price: "¥3,000", unit: "(含税)/次", description: "可在训练结束后加购的选配服务。由教练一对一带您进行30分钟的拉伸放松。" }, cta: "预约体验课程" },
  ...
  zhTW: {
    ...
    ], dropIn: { name: "單次訓練（適合來京都旅行的遊客）", price: "¥8,000", perSession: "1次", description: "無需加入會員，全套裝備免費提供，適合來京都旅行的遊客。", features: ["50分鐘一對一訓練", "無需加入會員", "運動服・鞋免費提供", "可提供簡單英語溝通"] }, option: { label: "加購", name: "私人伸展", duration: "30分鐘", price: "¥3,000", unit: "(含稅)/次", description: "可於訓練結束後加購的服務。由教練一對一帶您進行30分鐘的伸展放鬆。" }, cta: "預約體驗課程" },
  ...
  ko: {
    ...
    ], dropIn: { name: "1회 이용 (교토 여행객용)", price: "¥8,000", perSession: "1회", description: "회원가입 없이 1회 이용 가능. 교토 여행 중에도 이용하기 좋습니다.", features: ["50분 1:1 트레이닝", "회원가입 불필요", "운동복・신발 무료 제공", "간단한 영어 응대 가능"] }, option: { label: "옵션", name: "퍼스널 스트레칭", duration: "30분", price: "¥3,000", unit: "(부가세 포함)/회", description: "트레이닝 후에 추가하실 수 있는 옵션입니다. 트레이너가 1:1로 30분간 스트레칭을 진행합니다." }, cta: "체험 예약" },
