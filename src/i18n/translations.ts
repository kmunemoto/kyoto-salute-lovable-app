...
export const translations: Record<Lang, Dict> = {
  ...
  en: {
    meta: { title: "Affordable Personal Gym in Kyoto | Salute Goshominami | Free Trial Available", description: "Personal training gym in Kyoto's Nakagyo-ku, Goshominami area. Free trial available. From ¥4,000/session. No enrollment fee. Certified nutritionist trainer provides 1-on-1 training. All sportswear provided. 8 min from Marutamachi Station." },
    ...
    hero: { kicker: "Affordable Personal Gym in Goshominami, Kyoto | Free Trial Available", title1: "Not seeing results on your own?", titleAccent: "Your private gym in Goshominami.", sub: "Surpass your former self — achieve the best body of your life", desc: "A certified nutritionist trainer supports you at your own pace. From ¥4,000 per session with no enrollment fee — all rental equipment is free.", cta1: "Try a Free Session", cta2: "See Our Features" },
    concern: { kicker: "Concern", title: "Sound familiar?", items: ["Couldn't stick with the gym", "Don't know where to start", "Gave up on strict diets", "Felt self-conscious at big gyms"], footer: "Salute Goshominami was created to solve these problems." },
