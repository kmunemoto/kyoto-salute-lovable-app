...
type Dict = {
  ...
  voice: { kicker: string; title: string; googleReviews: string; changesTitle: string; changesSubtitle: string; voiceTitle: string; disclaimer: string; dietLabel: string; bodymakeLabel: string; dietResults: { main: string; sub: string; note: string }; bodymakeResults: { main: string; sub: string; note: string }; testimonials: { label: string; comment: string }[]; fromGoogle: string };
