...
export const translations: Record<Lang, Dict> = {
  ja: {
    meta: { title: "京都市中京区・御所南のパーソナルジム｜無料体験・1回¥4,000〜｜Salute御所南", description: "京都市中京区・御所南の完全マンツーマンパーソナルジム。丸太町駅・神宮丸太町駅から徒歩8分。栄養士資格を持つトレーナーが、運動初心者の方にも丁寧にサポート。入会金0円、無料体験受付中。" },
