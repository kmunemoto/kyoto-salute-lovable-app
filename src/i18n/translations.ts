...
export const translations: Record<Lang, Dict> = {
  ja: {
    ...
    ], dropIn: { name: "単発プラン（ビジター・観光客向け）", price: "¥8,000", perSession: "1回", description: "会員登録不要・手ぶらOK", features: ["1セッション50分", "会員登録不要", "ウェア・シューズ無料レンタル", "手ぶらOK"] }, option: { label: "オプション", name: "パーソナルストレッチ", duration: "30分", price: "¥4,000", unit: "（税込）/回", description: "トレーニングの後に追加していただけるオプションです。トレーナーがマンツーマンで30分間、体をほぐすストレッチを行います。", benefit: "デスクワークで肩や腰が張りやすい方、姿勢が気になる方におすすめです。トレーニングで使った筋肉をゆるめ、体を動かしやすい状態に整えます。", booking: "ご予約時にお選びいただけます。" }, cta: "まずは体験してみる" },
    ...
    recruit: {
      ...
      points: [
        "契約形態は業務委託契約です。お支払いは1セッションごとの歩合制で、1コマあたりの単価をお支払いします。具体的な金額はLINEでお伝えしています。",
        "完全個室・完全予約制。1セッション50分、完全マンツーマンでの指導です。複数のお客様を同時に見ることはありません。",
  ...
  en: {
    ...
    ], dropIn: { name: "Drop-in Personal Training (for travelers)", price: "¥8,000", perSession: "per session", description: "No membership required. All equipment provided. For travelers visiting Kyoto.", features: ["50-minute 1-on-1 session", "No membership required", "Training wear and shoes provided", "English-friendly support"] }, option: { label: "Option", name: "Personal Stretching", duration: "30 min", price: "¥4,000", unit: "(tax incl.) / session", description: "An add-on you can take after your workout. Your trainer guides you through 30 minutes of one-on-one stretching.", benefit: "Recommended if desk work leaves your shoulders or lower back tight, or if you are conscious of your posture. We loosen the muscles you have just worked so your body moves more easily.", booking: "Select it when you book." }, cta: "Book a Trial Session" },
  ...
  zh: {
    ...
    ], dropIn: { name: "单次训练（适合来京都旅行的游客）", price: "¥8,000", perSession: "1次", description: "无需会员注册，全套装备免费提供，适合来京都旅行的游客。", features: ["50分钟一对一训练", "无需会员注册", "运动服・鞋免费提供", "可支持简单英语沟通"] }, option: { label: "选配", name: "私人拉伸", duration: "30分钟", price: "¥4,000", unit: "(含税)/次", description: "可在训练结束后加购的选配服务。由教练一对一带您进行30分钟的拉伸放松。", benefit: "推荐给因久坐办公而肩部、腰部容易紧绷，或在意姿势的您。放松刚刚训练过的肌肉，让身体活动更轻松。", booking: "预约时可选择加购。" }, cta: "预约体验课程" },
  ...
  zhTW: {
    ...
    ], dropIn: { name: "單次訓練（適合來京都旅行的遊客）", price: "¥8,000", perSession: "1次", description: "無需加入會員，全套裝備免費提供，適合來京都旅行的遊客。", features: ["50分鐘一對一訓練", "無需加入會員", "運動服・鞋免費提供", "可提供簡單英語溝通"] }, option: { label: "加購", name: "私人伸展", duration: "30分鐘", price: "¥4,000", unit: "(含稅)/次", description: "可於訓練結束後加購的服務。由教練一對一帶您進行30分鐘的伸展放鬆。", benefit: "推薦給因久坐辦公而肩部、腰部容易緊繃，或在意姿勢的您。放鬆剛訓練過的肌肉，讓身體活動更輕鬆。", booking: "預約時可選擇加購。" }, cta: "預約體驗課程" },
  ...
  ko: {
    ...
    ], dropIn: { name: "1회 이용 (교토 여행객용)", price: "¥8,000", perSession: "1회", description: "회원가입 없이 1회 이용 가능. 교토 여행 중에도 이용하기 좋습니다.", features: ["50분 1:1 트레이닝", "회원가입 불필요", "운동복・신발 무료 제공", "간단한 영어 응대 가능"] }, option: { label: "옵션", name: "퍼스널 스트레칭", duration: "30분", price: "¥4,000", unit: "(부가세 포함)/회", description: "트레이닝 후에 추가하실 수 있는 옵션입니다. 트레이너가 1:1로 30분간 스트레칭을 진행합니다.", benefit: "책상 업무로 어깨나 허리가 자주 뭉치는 분, 자세가 신경 쓰이는 분께 권해 드립니다. 방금 트레이닝한 근육을 풀어 몸을 움직이기 편한 상태로 정리해 드립니다.", booking: "예약 시 선택하실 수 있습니다." }, cta: "체험 예약" },
