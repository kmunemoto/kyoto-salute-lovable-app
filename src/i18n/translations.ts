...
export const translations: Record<Lang, Dict> = {
  ja: {
    ...
    ], dropIn: { name: "単発プラン（ビジター・観光客向け）", price: "¥8,000", perSession: "1回", description: "会員登録不要・手ぶらOK", features: ["1セッション50分", "会員登録不要", "ウェア・シューズ無料レンタル", "手ぶらOK"] }, option: { label: "オプション", name: "パーソナルストレッチ", duration: "30分", price: "¥3,000", unit: "（税込）/回", description: "トレーニングの後に追加していただけるオプションです。トレーナーがマンツーマンで30分間、体をほぐすストレッチを行います。", benefit: "デスクワークで肩や腰が張りやすい方、姿勢が気になる方におすすめです。トレーニングで使った筋肉をゆるめ、体を動かしやすい状態に整えます。", booking: "ご予約時にお選びいただけます。" }, cta: "まずは体験してみる" },
  ...
  zh: {
    ...
    ], dropIn: { name: "单次训练（适合来京都旅行的游客）", price: "¥8,000", perSession: "1次", description: "无需会员注册，全套装备免费提供，适合来京都旅行的游客。", features: ["50分钟一对一训练", "无需会员注册", "运动服・鞋免费提供", "可支持简单英语沟通"] }, option: { label: "选配", name: "私人拉伸", duration: "30分钟", price: "¥3,000", unit: "(含税)/次", description: "可在训练结束后加购的选配服务。由教练一对一带您进行30分钟的拉伸放松。", benefit: "推荐给因久坐办公而肩部、腰部容易紧绷，或在意姿势的您。放松刚刚训练过的肌肉，让身体活动更轻松。", booking: "预约时可选择加购。" }, cta: "预约体验课程" },
