...
type Dict = {
  ...
  pricing: { kicker: string; title: string; freeNote: string; sub: string; popular: string; perMonth: string; dropInUnit: string; dropInCta: string; description: string; priceNote: { title: string; body: string }; plans: { name: string; price: string; perSession: string; description: string; features: string[] }[]; dropIn: { name: string; price: string; perSession: string; description: string; features: string[] }; options: { label: string; name: string; duration: string; price: string; unit: string; description: string; benefit: string; booking: string }[]; cta: string };
  flow: { kicker: string; title: string; steps: { title: string; description: string; imageAlt: string }[]; footer: string; bookText: string; bookLinkLabel: string };
...
export const translations: Record<Lang, Dict> = {
  ...
  en: {
    ...
    pricing: { kicker: "Plan", title: "Pricing Plans", freeNote: "Enrollment fee ¥0", sub: "Pick the plan that matches your goal.", popular: "Popular", perMonth: "(tax incl.) / month", dropInUnit: "(tax incl.) / session", dropInCta: "Book a Drop-in", description: "Choose from 3 monthly plans to match your goals. No enrollment fee. Every plan includes 1-on-1 training with free sportswear, shoes, towels and water.", priceNote: { title: "Current members keep their existing rates", body: "The monthly plan prices shown are for new members. If you are already a member, your previous rates still apply, including when you switch plans." }, plans: [
  ...
  zh: {
    ...
    pricing: { kicker: "Plan", title: "价格方案", freeNote: "入会费・手续费 ¥0", sub: "请根据您的目标选择方案。", popular: "推荐", perMonth: "(含税)/月", dropInUnit: "(含税)/次", dropInCta: "预约单次训练", description: "可根据您的目标，从3个月度方案中选择。入会费・手续费0日元。所有方案均为一对一指导，运动服・鞋・毛巾・水免费提供。", priceNote: { title: "已入会的会员，价格保持不变", body: "以上月度方案价格适用于新入会的顾客。已入会的会员即使变更方案，也适用调整前的价格。" }, plans: [
  ...
  zhTW: {
    ...
    pricing: { kicker: "Plan", title: "價格方案", freeNote: "入會費・手續費 ¥0", sub: "請依照您的目標選擇方案。", popular: "推薦", perMonth: "(含稅)/月", dropInUnit: "(含稅)/次", dropInCta: "預約單次訓練", description: "可依照您的目標，從3個月度方案中選擇。入會費・手續費0日圓。所有方案皆為一對一指導，運動服・鞋・毛巾・水免費提供。", priceNote: { title: "已入會的會員，價格維持不變", body: "以上月度方案價格適用於新入會的顧客。已入會的會員即使變更方案，也適用調整前的價格。" }, plans: [
