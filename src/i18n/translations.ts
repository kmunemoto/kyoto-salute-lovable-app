...
export const translations: Record<Lang, Dict> = {
  ja: {
    ...
    trainer: { kicker: "Trainer", title: "トレーナー紹介", name: "宗本 寛太", nameRoman: "Munemoto Kanta", role: "Salute御所南 代表トレーナー", qualLabel: "保有資格", qual: "栄養士", careerLabel: "経歴", career: "四条烏丸のパーソナルジムにて店長として勤務。月140組以上の指導経験を積み、2024年11月より「パーソナルジムSalute御所南」のトレーナーに就任。", messageLabel: "メッセージ", message: "「運動が苦手な方、ジムが初めての方もご安心ください。皆様の目標に向けて全力でサポートさせていただきます！」", greetingLabel: "トレーナーからのご挨拶", greetingParagraphs: [
      "これまで多くのお客様の体づくりをサポートする中で、繰り返し耳にしてきた2つの悩みがあります。",
      "「自分に合ったやり方がわからない」、そして「続けられない」という声です。",
      "Salute御所南では、こうした悩みを根本から解決するために、お客様一人ひとりの生活スタイルに合わせた「続けられるトレーニング」と「無理のない食事改善」をご提案しています。",
      "健康的に、そしてしっかりと体を変えるための第一歩を、一緒に踏み出しましょう。",
    ] },
  ...
  en: {
    meta: { title: "Affordable Personal Gym in Kyoto | Salute Goshonan | Free Trial Available", description: "Personal training gym in Kyoto's Nakagyo-ku, Goshonan area. Free trial available. From ¥4,000/session. No enrollment fee. Certified nutritionist trainer provides 1-on-1 training. All sportswear provided. 8 min from Marutamachi Station." },
    nav: { features: "Features", trainer: "Trainer", voice: "Reviews", plan: "Pricing", faq: "FAQ", access: "Access", consultation: "Free Trial", blog: "Blog" },
    header: { ctaBtn: "Free Trial" },
    hero: { kicker: "Affordable Personal Gym in Goshonan, Kyoto | Free Trial Available", title1: "Not seeing results on your own?", titleAccent: "Your private gym in Goshonan.", sub: "Surpass your former self — achieve the best body of your life", desc: "A certified nutritionist trainer supports you at your own pace. From ¥4,000 per session with no enrollment fee — all rental equipment is free.", cta1: "Try a Free Session", cta2: "See Our Features" },
    concern: { kicker: "Concern", title: "Sound familiar?", items: ["Couldn't stick with the gym", "Don't know where to start", "Gave up on strict diets", "Felt self-conscious at big gyms"], footer: "Salute Goshonan was created to solve these problems." },
    features: { kicker: "Features", title: "Why Choose Salute", items: [
      { title: "Your own private space to focus", description: "No other clients around. Train with just your trainer in a completely private room. Perfect for beginners who feel self-conscious." },
      { title: "See your progress in numbers", description: "Our custom app automatically tracks your training and body changes. Graphs and monthly reports keep you motivated." },
      { title: "Diet advice included", description: "Our trainer is a certified nutritionist who helps with both training and eating habits. No extreme diets — practical advice for real life." },
      { title: "Affordable enough to keep going", description: "From ¥4,000/session. No enrollment fee. Sportswear, shoes, towels & water all free. Designed for long-term commitment." },
    ], note: "Every plan includes fully 1-on-1 coaching with a custom training menu tailored to you.", cta: "Try a Free Session" },
    ...
    trainer: { kicker: "Trainer", title: "Your Trainer", name: "Kanta Munemoto", nameRoman: "Munemoto Kanta", role: "Head Trainer, Salute Goshonan", qualLabel: "Qualifications", qual: "Certified Nutritionist", careerLabel: "Career", career: "Former manager at a personal gym in Shijo-Karasuma, Kyoto, training 140+ clients per month. Joined Salute Goshonan as head trainer in November 2024.", messageLabel: "Message", message: "\"Even if you've never exercised before or this is your first time at a gym, don't worry. I'll fully support you toward your goal!\"", greetingLabel: "A Word from Your Trainer", greetingParagraphs: [
      ...
      "At Salute Goshonan, we solve these problems at the root — building training and eating habits that fit your lifestyle and that you can actually maintain.",
      "Let's take the first step together toward a healthier, stronger body.",
    ] },
    voice: { kicker: "Voice", title: "Client Results & Reviews", googleReviews: "17 Google Reviews", changesTitle: "Client Transformations", voiceTitle: "What Our Clients Say", disclaimer: "*Results vary by individual", dietLabel: "Female, 30s — Diet", bodymakeLabel: "Male, 40s — Bodymake", testimonials: [
      { label: "Female, 30s — Office Worker", comment: "The trainer gives precise guidance — something you only get with personal training. Pricing and session counts are very approachable, even for beginners." },
      { label: "Male, 40s — Desk Job", comment: "About 4 months in. The trainer varies sessions and adjusts them, so I feel real progress each time. Encouragement keeps my motivation high." },
      { label: "Female, 30s — Office Worker", comment: "A beginner here, but I'm enjoying it. Sportswear and shoes are free to borrow, so I can come empty-handed even between other plans." },
    ], fromGoogle: "From Google Reviews" },
    pricing: { kicker: "Plan", title: "Pricing Plans", freeNote: "Enrollment fee ¥0", sub: "Pick the plan that matches your goal.", popular: "Popular", perMonth: "(tax incl.) / month", description: "Choose from 4 plans to match your goals. No enrollment fee. All plans include 1-on-1 training with free sportswear rental.", plans: [
      { name: "4 Sessions / Month", price: "¥20,000", perSession: "¥5,000 / session", description: "For health upkeep & light fitness", features: ["60-minute session", "Up to 4 sessions/month", "Empty-handed OK", "App included"] },
      { name: "6 Sessions / Month", price: "¥28,500", perSession: "¥4,750 / session", description: "For training 1+ time a week", features: ["60-minute session", "Up to 6 sessions/month", "Empty-handed OK", "App included"] },
      { name: "8 Sessions / Month", price: "¥36,000", perSession: "¥4,500 / session", description: "For diet & bodymake", features: ["60-minute session", "Up to 8 sessions/month", "Empty-handed OK", "App included", "Diet advice"] },
      { name: "15 Sessions / Month", price: "¥60,000", perSession: "¥4,000 / session", description: "For serious diet & bodymake", features: ["60-minute session", "Up to 15 sessions/month", "Empty-handed OK", "App included", "Diet advice"] },
    ], dropIn: { name: "Drop-in Plan (Visitors & Travelers)", price: "¥8,000", perSession: "per session", description: "No membership required. All equipment provided.", features: ["60-minute session", "No membership required", "Free sportswear & shoes", "Empty-handed OK"] }, cta: "Try a Free Session" },
    flow: { kicker: "Flow", title: "How It Works", steps: [
      { title: "Book Online", description: " Choose your preferred date and time. Takes just 30 seconds." },
      { title: "Consultation + Training", description: "After a brief consultation, enjoy a 60-minute personal training session. Just come empty-handed." },
    ], footer: "Sportswear, shoes, towels & water are all provided free of charge.", bookText: "Use the ", bookLinkLabel: "booking form" },
    cta: { kicker: "Consultation", title: "Free Trial", paragraphs: ["Try it for yourself.", "Any concerns before signing up can be cleared up during the free trial.", "Experience the training and atmosphere firsthand."], bullets: ["Worried you're not athletic enough", "Wondering what the trainer is like"], webBtn: "Book Online", lineBtn: "Book via LINE" },
    faq: { kicker: "Q&A", title: "FAQ", items: [
      { question: "What happens during the free trial?", answer: "After a short consultation, you'll experience a real 60-minute personal training session. Sportswear and shoes are provided — come empty-handed." },
      { question: "I have no exercise experience. Is that OK?", answer: "Absolutely. Most of our clients had never trained before. We coach you carefully based on your fitness level and goals." },
      { question: "What should I bring?", answer: "Nothing. Sportswear, shoes, towels and water are all provided free of charge." },
      { question: "Do you offer drop-in sessions for tourists?", answer: "Yes! We offer a drop-in plan at ¥8,000 per session. No membership required. All sportswear and equipment are provided. Just book via Instagram DM or our website." },
      { question: "Is English support available?", answer: "Our trainer speaks basic English and can guide you through the workout. For detailed communication, we can use translation tools." },
      { question: "Is there a minimum contract?", answer: "No minimum contract. You can start with a single month." },
      { question: "Any extra costs?", answer: "None. Enrollment fee ¥0; sportswear, shoes, towels and water are all free." },
    ...
    access: { kicker: "Access", title: "Access", intro: "8 minutes on foot from Marutamachi Station. Exit 4, walk east along Marutamachi-dori. Plaza Goshonan, 2nd Floor. Also 8 minutes from Keihan Jingu-Marutamachi Station.", addressLabel: "Address", addressLines: ["604-0981", "Plaza Goshonan 2F, 533-1 Bishamoncho, Nakagyo-ku, Kyoto"], stationLabel: "Nearest Stations", stations: ["Kyoto City Bus 'Saibansho-mae' — 3 min walk", "Karasuma Subway Line 'Marutamachi' — 8 min walk", "Keihan 'Jingu-Marutamachi' — 8 min walk", "Karasuma Subway Line 'Kyoto Shiyakusho-mae' — 10 min walk"], hoursLabel: "Hours", hoursText: "10:00 – 22:00 (by reservation only)", hoursSub: "Open daily / outside hours may also be available on request", contactLabel: "Contact", contactText: "Questions and inquiries are handled via our official LINE or Instagram DM.", note: "* Bicycle parking available beside the stairs on the 1st floor of the building. * For cars, please use nearby coin parking.", sponsorsLabel: "Sponsors" },
    footer: { blog: "Blog", app: "Official App", line: "LINE", terms: "Terms", privacy: "Privacy Policy", tokusho: "Specified Commercial Transactions Act", copyright: "Personal Gym Salute Goshonan", address: "Plaza Goshonan 2F, 533-1 Bishamoncho, Nakagyo-ku, Kyoto", related: "Related: " },
