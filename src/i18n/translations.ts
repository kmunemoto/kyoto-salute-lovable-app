...
type Dict = {
  ...
  pricing: { kicker: string; title: string; freeNote: string; sub: string; popular: string; perMonth: string; dropInUnit: string; dropInCta: string; description: string; priceNote: string; plans: { name: string; price: string; perSession: string; description: string; features: string[] }[]; dropIn: { name: string; price: string; perSession: string; description: string; features: string[] }; options: { label: string; name: string; duration: string; price: string; unit: string; description: string; benefit: string; booking: string }[]; cta: string };
