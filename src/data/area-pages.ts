...
export const AREA_PAGES: AreaPage[] = [
  {
    ...
    line: "地下鉄烏丸線",
    walk: "徒歩8分",
    metaTitle: "丸太町駅のパーソナルジム｜Salute御所南｜完全個室・入会金¥0・体験受付中",
    metaDescription:
      "丸太町駅から徒歩8分のパーソナルジムSalute御所南。完全個室・栄養士トレーナーがマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK・当日キャンセルも無料。体験¥3,000（当日入会で¥0）。",
  ...
  },
  {
    ...
    metaDescription:
      "烏丸御池駅から地下鉄で1駅・丸太町駅徒歩8分のパーソナルジムSalute御所南。完全個室でマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK。仕事帰りにも通える。体験¥3,000（当日入会で¥0）。",
    ...
    relatedBlog: "desk-work-shoulder-back-pain-personal-gym",
  },
  {
    ...
    line: "地下鉄東西線",
    walk: "徒歩10分",
    metaTitle: "京都市役所前のパーソナルジム｜Salute御所南｜完全個室・体験受付中",
    metaDescription:
      "京都市役所前駅から徒歩10分のパーソナルジムSalute御所南。完全個室・栄養士トレーナーがマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK・当日キャンセルも無料。体験¥3,000（当日入会で¥0）。",
  ...
  },
  {
    ...
    metaDescription:
      "神宮丸太町駅から徒歩8分のパーソナルジムSalute御所南。京阪沿線から通える完全個室のジム。栄養士トレーナーがマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK。体験¥3,000（当日入会で¥0）。",
