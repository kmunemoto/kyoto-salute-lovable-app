...
export const AREA_PAGES: AreaPage[] = [
  {
    ...
    metaDescription:
      "丸太町駅から徒歩8分のパーソナルジムSalute御所南。完全個室・栄養士トレーナーがマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK・前日まで予約変更OK。無料体験実施中。",
  ...
  },
  {
    ...
    metaDescription:
      "京都市役所前駅から徒歩10分のパーソナルジムSalute御所南。完全個室・栄養士トレーナーがマンツーマン指導。入会金¥0・1回¥4,000〜・手ぶらOK・前日まで予約変更OK。無料体験実施中。",
